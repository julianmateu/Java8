...
/**
 * User filter test class for the DreamSys tutorial.
 * 
 * @see <a href="http://www.dreamsyssoft.com/java-8-lambda-tutorial/filter-tutorial.php">Filter</a>
 */
public class UserFilterTest {
  ...
  private static void newJavaWayTwo() {
	  	List<User> olderUsers = users.stream().filter(u -> u.age > 30 || u.lastName.startsWith("S")).collect(Collectors.toList());
	    printListNewWay("New way older users or users whose last name starts with S", olderUsers);
	  }
